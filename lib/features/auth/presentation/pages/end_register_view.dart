            ...
            builder: (context, state) {
              return Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: GestureDetector(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text('Vaccine date',style: openSans(14.sp, defaultColor, FontWeight.w600),textScaleFactor: 1,),
                                        SizedBox(height: 8.h,),
                                        Container(
                                          ...
                                          child: Row(
                                            crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                                              Icon(Icons.accessibility,color: oldSilver,size: 20.r,),
                                              SizedBox(width: 8.w,),
                                              Text(vaccineDate??'Vaccine date',style: openSans(14,vaccineDate!=null? Colors.black:oldSilver,vaccineDate!=null? FontWeight.w600:FontWeight.w300),)
                                            ],
                                          ),
                                        ),
                                      ],
                                      ...
                                      Expanded(
                                        child: DropdownButtonFormField(
                                          ...
                                          onChanged: (String? value) {
                                            if (value != null) {
                                              bloodType = value;
                                              authCubit.changeSelectedBloodType(value);
                                            }
                                          },
                                        ),
                                      ),
                        ...
                        passwordTextField(
                          ...
                          onSubmit: () => FocusScope.of(context)
                              .requestFocus(passwordVerifyFocusNode), obscureText: passwordVisible, onTap: () =>authCubit.changeRegisterPasswordVisibility(!passwordVisible),
                        ),
                        SizedBox(height: 8.h,),
                        passwordTextField(
                          ...
                          onSubmit: () => FocusScope.of(context)
                              .unfocus(), obscureText: passwordVerifyVisible, onTap: () =>authCubit.changeRegisterPasswordVerifyVisibility(!passwordVerifyVisible),
                        ),
                      ],
                    ),
                  ),),
                  ...
                  defaultButton(onTap: (){}, text: 'Sign up')
                ],
              );
            },
          ),
